<%@ Page Title="" Language="C#" MasterPageFile="~/Admin_Master.Master" AutoEventWireup="true" CodeBehind="QuanlyMonAn.aspx.cs" Inherits="DoAnThuongMaiDienTu.QuanlyMonAn" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="height: 100%; width: 80%; margin-left: 12%; display: flex; justify-content: space-between; align-items: center;">
        ...
        <div class="form" style="margin-right: 50px;">
            ...
            <div class="field">
                <asp:TextBox ID="txt_tenmon" runat="server" CssClass="view_input"></asp:TextBox>
                <label for="name" class="label-name">
                    <span class="label-content">Tên món:</span>
                </label>
            </div>
            <div class="field">
                <asp:TextBox ID="txt_dongia" runat="server" CssClass="view_input"></asp:TextBox>
                <label for="name" class="label-name">
                    <span class="label-content">Đơn giá:</span>
                </label>
            </div>
            <div class="field">
                <asp:TextBox ID="txt_thanhphan" runat="server" CssClass="view_input" TextMode="MultiLine"></asp:TextBox>
                <label for="name" class="label-name">
                    <span class="label-content">Thành phần:</span>
                </label>
            </div>
            <div class="field">
                <asp:TextBox ID="txt_loai" runat="server" CssClass="view_input"></asp:TextBox>
                <label for="name" class="label-name">
                    <span class="label-content">Loại</span>
                </label>
            </div>
            <div class="field">
        ...
        <div style="max-height: 500px; overflow-x: hidden; overflow-y: auto;">
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"     >
                <Columns>
                    <asp:BoundField DataField="mamon" HeaderText="Mã món" SortExpression="mamon" />
                    <asp:BoundField DataField="tenmon" HeaderText="Tên món" SortExpression="tenmon" />
                    <asp:BoundField DataField="dongia" HeaderText="Đơn giá" SortExpression="dongia" />
                    <asp:BoundField DataField="thanhphan" HeaderText="Thành phần" SortExpression="thanhphan" />
                    <asp:BoundField DataField="loai" HeaderText="Loại" SortExpression="loai" />
                    <asp:TemplateField HeaderText="Hình ảnh">
                        <ItemTemplate>
                            <asp:Image ID="Image1" runat="server" ImageUrl='<%#"~/Web_View/Home/images/"+Eval("hinhanh") %>' CssClass="img" />
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            </asp:GridView>
    ...
    <script>
        ...
        let txt_mamon = document.querySelector("#ContentPlaceHolder1_txt_mamon");
        let txt_tenmon = document.querySelector("#ContentPlaceHolder1_txt_tenmon");
        let txt_thanhphan = document.querySelector(
            "#ContentPlaceHolder1_txt_thanhphan"
        );
        let txt_dongia = document.querySelector("#ContentPlaceHolder1_txt_dongia");
        let txt_loai = document.querySelector("#ContentPlaceHolder1_txt_loai");
