<%@ Page Title="" Language="C#" MasterPageFile="~/Web_View/MasterPage/MasterNavFull.Master" AutoEventWireup="true" CodeBehind="store.aspx.cs" Inherits="DoAnThuongMaiDienTu.Web_View.Home.store" %>
    ...
    <div class="container">
        <div class="link">
            <div class="link-content">
                ...
                <asp:LinkButton ID="LinkButton2" runat="server" CssClass="link-btn btn-active">Store</asp:LinkButton>
            </div>
        </div>
    </div>
    <div class="recommend">
        <div class="recommend_content" style="padding-top: 20px">
            <h2 style="margin-bottom: 50px; font-size: 38px;">STORE</h2>
